...
e){return Math.min(a,e[b])},Number.MAX_VALUE)},maxInArray:function(a,b){return a.reduce(function(a,e){return Math.max(a,e[b])},-Number.MAX_VALUE)},getArrayExtremes:function(a,b,c){return a.reduce(function(a,h){return[Math.min(a[0],h[b]),Math.max(a[1],h[c])]},[Number.MAX_VALUE,-Number.MAX_VALUE])}}});c(a,"Stock/Indicators/WilliamsRIndicator.js",[a["Core/Utilities.js"],a["mixins/reduce-array.js"]],function(a,b){var c=a.isArray;a=a.seriesType;var e=b.getArrayExtremes;a("williamsr","sma",{params:{period:14}},
